 ...
 */
import image from "../images/cyyber.jpg";

const imageAltText = "futuristic cyber themed background";
...
const projectList = [
  {
    ...
    description:
      "Wrote a blog on deep diving into APIs.",
